...
const Terminal: React.FC = () => {
  ...
  const [history, setHistory] = useState<TerminalEntry[]>([
    { type: 'output', content: 'Welcome to the terminal! Type `help` to get started.' },
  ]);
  ...
  const handleCommand = (cmd: string) => {
    ...
    if (cmd === 'git push') {
      const componentOutput = (
        ...
        I AM TRYING!
          <Image src="https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExc2g2NTZhajRmbWpnazBkb3VsNWtqbHczcm1hemJyZ3N5aWU4em14ciZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/UCprfrXABmEKG1a8SE/giphy.gif" className='object-cover w-full h-[300px]' width={'50'} height={'100'} alt="kya hua" />
        </div>
      );
      setHistory((prev) => [...prev, { type: 'component', content: componentOutput }]);
      return;
     ...
     if (cmd === 'git add') {
      const componentOutput = (
        <div className="p-3 rounded mt-2 text-white">
        Done!
          <Image src="https://media1.tenor.com/m/c4YEuiMQfBAAAAAd/ryan-howard-bj-novak.gif" className='object-cover w-full h-[400px]' width={'50'} height={'100'} alt="kya hua" />
        </div>
      );
      setHistory((prev) => [...prev, { type: 'component', content: componentOutput }]);
      return;
    ...
    if (cmd === 'my dream') {
      const componentOutput = (
        <div className="p-3 rounded mt-2 text-white">
          <Image src="https://media1.tenor.com/m/BEsL9FFFGN4AAAAd/the-office-michael-scott.gif" className='object-cover w-full h-[400px]' width={'50'} height={'100'} alt="kya hua" />
        </div>
      );
      setHistory((prev) => [...prev, { type: 'component', content: componentOutput }]);
      return;
     ...
     if (cmd === 'kill') {
      const componentOutput = (
        <div className="p-3 rounded mt-2 text-white">
         Ha! Got you first! 
          <Image src="https://media1.tenor.com/m/T9ggIIvCZ_EAAAAC/the-office-gun.gif" className='object-cover w-full h-[400px]' width={'50'} height={'100'} alt="kya hua" />
        </div>
      );
      setHistory((prev) => [...prev, { type: 'component', content: componentOutput }]);
      return;
     ...
     if (cmd === 'facts') {
      const componentOutput = (
        ...
        <ul className='text-white'>
          <li className='flex '><FaDev className='mt-1 mr-1'/> Web Developer</li>
          <li className='flex '><GiArtificialHive className='mt-1 mr-1'/> ML Engnieer</li>
          <li className='flex '><IoPlanet className='mt-1 mr-1'/>Astrophysics Researcher</li>
          <li className='flex '><IoIosMusicalNotes className='mt-1 mr-1'/>Muscisian</li>
  ...
  return (
    <div className="bg-black text-green-400 p-4 w-full max-w-2xl font-mono rounded shadow-lg mx-auto">
      ...
      <div className="overflow-y-auto h-[500px] mb-4 pr-2 space-y-2">
