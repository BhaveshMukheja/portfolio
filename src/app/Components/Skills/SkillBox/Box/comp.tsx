...
const Comp: React.FC<CompProps> = ({ id, logo, title, skills }) => {
  ...
  return (
    ...
    >
      <div className="relative p-2 w-full h-full rounded-[15px] overflow-hidden transition-all duration-300  hover:shadow-[0px_4px_6px_0px_rgba(0,_0,_0,_0.1)] group border border-transparent hover:border-gray-500">
        <div className="grid grid-rows-2 grid-cols-5 z-10 font-rob">
          ...
          <div className="col-span-4 row-span-1 flex items-center text-black text-sm md:text-lg lg:text-md">
            {title}
          </div>
          <div
            className={`col-span-4 row-span-1 text-xs md:text-sm lg:text-sm flex items-center ${
