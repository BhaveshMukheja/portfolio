  ...
  return (
    <footer className="relative bg-[#0A0E1A] text-white pt-12 pb-8 px-6 md:px-16">
      <div className="max-w-7xl mx-auto  grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <p className="mt-3 text-sm text-gray-400">
            Astrophysicist, Full Stack Developer & Machine Learning Enthusiast based in India.
          </p>
        </div>
        ...
        <div className=''>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            <li><a href="/coming_soon" className="hover:underline" target="_blank" rel="noopener noreferrer">Resume ↗</a></li>
      ...
      <div className="border-t border-gray-800 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
        <p>© {year} Bhavesh Mukheja. All rights reserved. 3D Model and wallpapers used have been credited in the code.</p>
        <p>
